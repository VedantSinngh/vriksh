...
export default function AboutPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <div className="relative w-full h-48 md:h-64 mt-20 px-8 rounded-3xl overflow-hidden">
                <Image src="/about.png" alt="Ahmedabad cityscape" fill className="object-cover" />
            ...
            <main className="container mx-auto px-4 py-8">
                <section className="max-w-4xl mx-auto mb-16 text-[#080a0f]">
